...
public class Test1 {
    public static void main(String[] args) throws IOException {
        ...
        */
        ...
        /*
        	分组核心在这里：
            regex正则参数解释：(.{4})(，|。)
            1.分了两组，第一组：4个任意字符，第二组是，或这。
            2.匹配，对有连续4个任意字符加上后面是中文，或者。进行匹配
         */
    ...
    /**
     * 作用：根据正则爬取网页内容
     * @param familyNameStr html网页内容
     * @param regex 正则
     * @param index 分组
     * @return
     */
    public static ArrayList<String> getData(String familyNameStr, String regex, int index) {
        ...
        // 2.按照正则表达式的规则，去获取数据
        Pattern p = Pattern.compile(regex);
        Matcher m = p.matcher(familyNameStr);
        while (m.find()) {
            // 这里index传递的是1，表示我们要匹配到的结果的，第一组内容，也就是4个任意字符
    ...
    public static String webCrawler(String net) throws IOException {
        ...
        // 3.链接上这个网址
        // 注意点：必须保证网络畅通，且url可访问
        URLConnection conn = url.openConnection();


        // 4.读取
        // 需要用转换流，转成字符流
        // 原因：1.getInputStream是个字节流 2.链接中有中文，需要用字符流读取
